-- Extra district comes at Early Empire
...
UPDATE Modifiers SET SubjectRequirementSetId='BBG_UTILS_PLAYER_HAS_CIVIC_EARLY_EMPIRE_REQSET' WHERE ModifierId='TRAIT_EXTRA_DISTRICT_EACH_CITY';
...
-- Barbarossa's +7 Combat Strength also applies against civilization unique units.
...
UPDATE Modifiers
SET SubjectRequirementSetId='BBG_UNIT_IS_UNIQUE_OR_MINOR'
