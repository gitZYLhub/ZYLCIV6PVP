...
-- Initiation Rites gives 40% gold for each non-civilian unit produced
...
INSERT INTO ModifierArguments(ModifierId, Name, Value) VALUES
    ...
    ('BBG_INITIATION_RITES_FAITH_YIELD_MODIFIER', 'YieldType', 'YIELD_GOLD'),
    ('BBG_INITIATION_RITES_FAITH_YIELD_MODIFIER', 'UnitProductionPercent', '40'),
