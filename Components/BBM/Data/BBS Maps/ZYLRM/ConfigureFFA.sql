...
-- 74/78/80) and add two runtime columns for a forced deep ocean at the wrap
...
VALUES
('MAPSIZE_ZYL_FFA_3', 'LOC_ZYLRM_MAPSIZE_3_NAME', 'LOC_ZYLRM_FFA_MAPSIZE_3_DESCRIPTION', 3, 3, 62, 42, 3, 2),
('MAPSIZE_ZYL_FFA_5', 'LOC_ZYLRM_MAPSIZE_5_NAME', 'LOC_ZYLRM_FFA_MAPSIZE_5_DESCRIPTION', 5, 4, 66, 56, 4, 3),
('MAPSIZE_ZYL_FFA_7', 'LOC_ZYLRM_MAPSIZE_7_NAME', 'LOC_ZYLRM_FFA_MAPSIZE_7_DESCRIPTION', 7, 5, 70, 68, 4, 4),
('MAPSIZE_ZYL_FFA_9', 'LOC_ZYLRM_MAPSIZE_9_NAME', 'LOC_ZYLRM_FFA_MAPSIZE_9_DESCRIPTION', 9, 6, 74, 80, 5, 5),
('MAPSIZE_ZYL_FFA_11', 'LOC_ZYLRM_MAPSIZE_11_NAME', 'LOC_ZYLRM_FFA_MAPSIZE_11_DESCRIPTION', 11, 7, 80, 88, 6, 6);
