...
function DW_MarkCoastalLowlands()
	...
	if tilesToMark > 0 then
		...
		print(tostring(tilesToMark).." 沿海低地已添加");
		print("  " .. tostring(#scoredTiles) .. " 合格的沿海低地");
		]]
		print(tostring(tilesToMark) .. " coastal lowlands added")
		print(tostring(#scoredTiles) .. " eligible coastal lowland plots")
	end
end
