...
-- economic policy slot until Early Empire has been completed.
INSERT OR IGNORE INTO RequirementSets
	(RequirementSetId, RequirementSetType)
VALUES
	('ZYL_TPVP_PLAYER_HAS_EARLY_EMPIRE', 'REQUIREMENTSET_TEST_ALL');
...
INSERT OR IGNORE INTO RequirementSetRequirements
	(RequirementSetId, RequirementId)
VALUES
	('ZYL_TPVP_PLAYER_HAS_EARLY_EMPIRE',
	 'ZYL_TPVP_PLAYER_HAS_EARLY_EMPIRE_REQUIREMENT');

UPDATE Modifiers
SET OwnerRequirementSetId = 'ZYL_TPVP_PLAYER_HAS_EARLY_EMPIRE'
...
-- Tier 1: +10% Production toward Encampments, +50% Production toward their
-- buildings, and +1 Production from Barracks and Stables.
-- Tier 2: Armories +2 Production, Military Academies +4 Production, +1
-- Military policy slot, Vampires +1 Movement.
-- Tier 3: every Encampment building provides +2 Science and +1 Culture.
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType)
VALUES
	...
	('ZYL_TPVP_SANGUINE_BARRACKS_SCIENCE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_BARRACKS_CULTURE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_STABLE_SCIENCE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_STABLE_CULTURE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_ARMORY_SCIENCE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_ARMORY_CULTURE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_SCIENCE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_CULTURE', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE');
...
VALUES
	...
	('ZYL_TPVP_SANGUINE_BARRACKS_SCIENCE', 'BuildingType', 'BUILDING_BARRACKS'),
	('ZYL_TPVP_SANGUINE_BARRACKS_SCIENCE', 'YieldType', 'YIELD_SCIENCE'),
	('ZYL_TPVP_SANGUINE_BARRACKS_SCIENCE', 'Amount', 2),
	('ZYL_TPVP_SANGUINE_BARRACKS_CULTURE', 'BuildingType', 'BUILDING_BARRACKS'),
	('ZYL_TPVP_SANGUINE_BARRACKS_CULTURE', 'YieldType', 'YIELD_CULTURE'),
	('ZYL_TPVP_SANGUINE_BARRACKS_CULTURE', 'Amount', 1),
	('ZYL_TPVP_SANGUINE_STABLE_SCIENCE', 'BuildingType', 'BUILDING_STABLE'),
	('ZYL_TPVP_SANGUINE_STABLE_SCIENCE', 'YieldType', 'YIELD_SCIENCE'),
	('ZYL_TPVP_SANGUINE_STABLE_SCIENCE', 'Amount', 2),
	('ZYL_TPVP_SANGUINE_STABLE_CULTURE', 'BuildingType', 'BUILDING_STABLE'),
	('ZYL_TPVP_SANGUINE_STABLE_CULTURE', 'YieldType', 'YIELD_CULTURE'),
	('ZYL_TPVP_SANGUINE_STABLE_CULTURE', 'Amount', 1),
	('ZYL_TPVP_SANGUINE_ARMORY_SCIENCE', 'BuildingType', 'BUILDING_ARMORY'),
	('ZYL_TPVP_SANGUINE_ARMORY_SCIENCE', 'YieldType', 'YIELD_SCIENCE'),
	('ZYL_TPVP_SANGUINE_ARMORY_SCIENCE', 'Amount', 2),
	('ZYL_TPVP_SANGUINE_ARMORY_CULTURE', 'BuildingType', 'BUILDING_ARMORY'),
	('ZYL_TPVP_SANGUINE_ARMORY_CULTURE', 'YieldType', 'YIELD_CULTURE'),
	('ZYL_TPVP_SANGUINE_ARMORY_CULTURE', 'Amount', 1),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_SCIENCE', 'BuildingType', 'BUILDING_MILITARY_ACADEMY'),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_SCIENCE', 'YieldType', 'YIELD_SCIENCE'),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_SCIENCE', 'Amount', 2),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_CULTURE', 'BuildingType', 'BUILDING_MILITARY_ACADEMY'),
	('ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_CULTURE', 'YieldType', 'YIELD_CULTURE'),
...
VALUES
	...
	('GOVERNOR_PROMOTION_SANGUINE_PACT_2', 'ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_PRODUCTION'),
	...
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_BARRACKS_SCIENCE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_BARRACKS_CULTURE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_STABLE_SCIENCE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_STABLE_CULTURE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_ARMORY_SCIENCE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_ARMORY_CULTURE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_SCIENCE'),
	('GOVERNOR_PROMOTION_SANGUINE_PACT_3', 'ZYL_TPVP_SANGUINE_MILITARY_ACADEMY_CULTURE');
