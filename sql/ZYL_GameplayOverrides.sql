...
-------------------------------------------------------------------------------
-- Russia: faith on Tundra in cities with a Lavra
-------------------------------------------------------------------------------

-- The bonus is city-scoped: once a city has a Lavra, all of its Tundra and
-- Tundra Hills tiles receive +1 Faith, regardless of adjacency.
INSERT OR IGNORE INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
	('ZYL_RUSSIA_FLAT_TUNDRA_CITY_HAS_LAVRA', 'REQUIREMENTSET_TEST_ALL'),
	('ZYL_RUSSIA_TUNDRA_HILLS_CITY_HAS_LAVRA', 'REQUIREMENTSET_TEST_ALL');
...
INSERT OR IGNORE INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
	('ZYL_RUSSIA_FLAT_TUNDRA_CITY_HAS_LAVRA', 'REQUIRES_PLOT_HAS_TUNDRA'),
	('ZYL_RUSSIA_FLAT_TUNDRA_CITY_HAS_LAVRA', 'BBG_CITY_HAS_DISTRICT_LAVRA_REQUIREMENT'),
	('ZYL_RUSSIA_TUNDRA_HILLS_CITY_HAS_LAVRA', 'REQUIRES_PLOT_HAS_TUNDRA_HILLS'),
	('ZYL_RUSSIA_TUNDRA_HILLS_CITY_HAS_LAVRA', 'BBG_CITY_HAS_DISTRICT_LAVRA_REQUIREMENT');

UPDATE Modifiers
SET SubjectRequirementSetId = 'ZYL_RUSSIA_FLAT_TUNDRA_CITY_HAS_LAVRA'
WHERE ModifierId = 'TRAIT_INCREASED_TUNDRA_FAITH';

UPDATE Modifiers
SET SubjectRequirementSetId = 'ZYL_RUSSIA_TUNDRA_HILLS_CITY_HAS_LAVRA'
