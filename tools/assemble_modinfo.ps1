...
$target.DocumentElement.SetAttribute('version', '125')
...
$localizedUpdates['LOC_ZYL_MPS_TITLE'] = @('LOC_ZYLPVPMOD_TITLE', 'ZYLPVPMOD 1.2.5', 'ZYLPVPMOD 1.2.5')
