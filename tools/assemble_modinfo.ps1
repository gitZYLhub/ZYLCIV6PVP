...
$target.DocumentElement.SetAttribute('version', '124')
...
$localizedUpdates['LOC_ZYL_MPS_TITLE'] = @('LOC_ZYLPVPMOD_TITLE', 'ZYLPVPMOD 1.2.4', 'ZYLPVPMOD 1.2.4')
