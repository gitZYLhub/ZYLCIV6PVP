...
local RELOAD_CACHE_ID			 = "GreatPeoplePopup";		-- hotloading
...
local m_filterClassID = -1; -- -1 for All, >-1 for Great Person Class ID
local m_filterPlayerID = -1; -- -1 for All, >-1 for Player ID (as in GetLocalPlayer() or Players[])
-- ===========================================================================
...
-- ===========================================================================
function Refresh( newRefreshFunc )
...
--	Tab callback
-- ===========================================================================
function OnGreatPeopleClick( uiSelectedButton )
	ResetTabButtons();
...
--	Tab callback
-- ===========================================================================
function OnPreviousRecruitedClick( uiSelectedButton )
	ResetTabButtons();
	SetTabButtonsSelected(uiSelectedButton);
...
-- =======================================================================================
function AddTabInstance( buttonText, callbackFunc )
...
-- =======================================================================================
function SelectTab( buttonControl )
	m_tabs.SelectTab(buttonControl);
end

-- =======================================================================================
function SetTabButtonsSelected( buttonControl )
