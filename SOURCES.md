...
生成的统一 Mod ID 为 `4dd01931-9d44-4a8a-8e74-712cba0f0072`，ModInfo 版本为 `203`，用户可见版本为 `2.0.3`。
...
- BBG / Team PVP / LightweightBalance 规则覆盖：黑暗/普通和黄金时代基础分界分别设为 20/23；新增默认开启的大厅时代长度选项，开启时标准速度下远古至信息时代固定为 48/46/44/42/42/40/40/40 回合（联机速度分别为 24/23/22/21/21/20/20/20/20 回合）；取消 BBG 中世纪以后科技统一 +5% 基础成本，落后时代科技改为 -25%；天文导航改为研究航海术后即可直接研究，并保留所有陆地单位上船解锁，同时按用户指定来源覆盖八项尤里卡/鼓舞。
