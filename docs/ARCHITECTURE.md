...
- `UiChecks.ps1` 逐步承接 UI/QoL 的文件、Criteria/Action、上下文和安全源码契约；现覆盖首批 TPT 功能、Better Trade Screen、外交交易/地图标记集成链、全局跨组件 Context 唯一性，以及 MPH EndGame 布局与 BBG Lua 扩展所有权，并以真实源码和错误动作图反例自检。
